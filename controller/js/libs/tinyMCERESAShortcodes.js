...
*/
(function() {
  tinymce.create('tinymce.plugins.RESAShortcodes', {
    init : function(editor, url) {
      editor.addButton('RESAMenuShortCodes', {
        type: 'menubutton',
        text: 'Raccourcies',
        icon: false,
        menu: [{
  ...
  tinymce.PluginManager.add( 'RESA_shortcodes', tinymce.plugins.RESAShortcodes );
})();
